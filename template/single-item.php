    ...
    <?php 
        ...
        <header>
            <img src="upload/<?php echo $prodotto["nome_prodotto"] ?>.jpg" alt=""/><section>
                ...
                </div><button type="button" onclick="addToCartIfUserIsLogged(<?php echo $prodotto['nome_prodotto'] ?>, getQuantity(), <?php echo $_SESSION['email']?>)">Aggiungi al carrello</button>
            </section>
        </header>
