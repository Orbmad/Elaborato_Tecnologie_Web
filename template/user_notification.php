        ...
        <ul>
            <?php foreach ($templateParams["notifiche"] as $notifica): ?>
                <li>
                    ...
                    </h3><img class="<?php if (notificationNotRead($notifica['messaggio'], $notifica['dataRec'], $notifica['id_notifica'], $dbh)) {
                                            echo 'show';
                                        } else {
                                            echo 'hidden';
                                        } ?>" src="./upload/Notif-circle.png" alt="notification to read" />
